...
const CHANGELOG = [
  {
    ...
    date: 'May 14, 2026',
    changes: [
      'Added graph coloring algorithm.',
    ],
  },
  {
    version: 'v1.1.0',
        ...
        <header className="text-center space-y-8 animate-fade-in">
          ...
          <div className="pt-6 flex justify-center items-center gap-4">
            <Link to="/app" className="inline-block relative group">
              ...
              <button className="cursor-pointer relative px-8 py-3.5 bg-bg-elevated hover:bg-gradient-to-r from-accent to-info text-white rounded-lg font-medium transition-all flex items-center gap-2">
                Open Graph Editor
